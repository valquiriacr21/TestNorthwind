...
using TestNorthwind.Models.DTOS.Requests;
using TestNorthwind.Models.DTOS.Responses;
        ...
        public async Task<IActionResult> Login([FromBody] UserLoginRequest user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (existingUser == null)
                {
                    ...
                    {
                        Errors = new List<string>() {
                                "Invalid login request, the user not exist"
                            },
                        Success = false
                    });
                }
                ...
                if (!isCorrectPassword)
                {
                    ...
                    {
                        Errors = new List<string>() {
                                "Invalid login request, the password is incorrect"
                            },
                        Success = false
                    });
                }
